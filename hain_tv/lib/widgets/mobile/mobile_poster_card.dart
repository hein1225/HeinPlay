...
class MobilePosterCard extends StatefulWidget {
  final String title;
  ...
  @override
  State<MobilePosterCard> createState() => _MobilePosterCardState();
}

class _MobilePosterCardState extends State<MobilePosterCard> {
  bool _pressed = false;
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          widget.subtitle ??
                              (widget.year.isNotEmpty ? widget.year : '未知年份'),
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                          style: const TextStyle(
                            fontFamily: 'NotoSansSC',
