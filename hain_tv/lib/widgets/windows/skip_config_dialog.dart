              ...
              children: [
                Checkbox(
                  ...
                  onChanged: (value) => _updateSegment(
                    index,
                    segment.copyWith(autoSkip: value ?? segment.autoSkip),
                  ),
                ),
                const Text(
                  '自动跳过',
                ...
                if (segment.type == 'ending') ...[
                  ...
                  Checkbox(
                    ...
                    onChanged: (value) => _updateSegment(
                      index,
                      segment.copyWith(
                        autoNextEpisode: value ?? segment.autoNextEpisode,
                      ),
                    ),
                  ),
                  const Text(
