 ...
 *
 * <p>tvlegacy 补丁版本：将原版的 API_LEVELS 判断改为 Build.VERSION_CODES 常量，并显式区分
 * API 26+ / API 24-25 / API 23 及以下三个分支，避免在 Android 5.1（API 22）上调用
 * Configuration.getLocales() / LocaleList 等 API 24 才有的方法而闪退。
 */
