...
import 'package:flutter_mpv_video/flutter_mpv_video_controls/flutter_mpv_video_controls.dart';

import 'package:flutter_mpv_video/src/subtitle/subtitle_view.dart';
import 'package:flutter_mpv_video/flutter_mpv_video_controls/flutter_mpv_video_controls.dart'
    as flutter_mpv_video_controls;
import 'package:flutter_mpv_video/src/utils/dispose_safe_notifer.dart';

import 'package:flutter_mpv_video/src/utils/wakelock.dart';
import 'package:flutter_mpv_video/src/video_view_parameters.dart';
...
class Video extends StatefulWidget {
  ...
  const Video({
    ...
    this.controls = flutter_mpv_video_controls.AdaptiveVideoControls,
    this.wakelock = true,
...
class VideoState extends State<Video> with WidgetsBindingObserver {
  ...
  // Public API:
  bool isFullscreen() {
    return flutter_mpv_video_controls.isFullscreen(_contextNotifier.value!);
  }

  Future<void> enterFullscreen() {
    return flutter_mpv_video_controls.enterFullscreen(_contextNotifier.value!);
  }

  Future<void> exitFullscreen() {
    return flutter_mpv_video_controls.exitFullscreen(_contextNotifier.value!);
  }

  Future<void> toggleFullscreen() {
    return flutter_mpv_video_controls.toggleFullscreen(_contextNotifier.value!);
  }
  ...
  void didChangeDependencies() {
    videoViewParametersNotifier =
        flutter_mpv_video_controls.VideoStateInheritedWidget.maybeOf(
              context,
            )?.videoViewParametersNotifier ??
  ...
  @override
  Widget build(BuildContext context) {
    return flutter_mpv_video_controls.VideoStateInheritedWidget(
...
Future<void> defaultEnterNativeFullscreen() async {
  try {
    if (Platform.isAndroid || Platform.isIOS) {
      ...
      await const MethodChannel('com.mohammed/flutter_mpv_video').invokeMethod(
