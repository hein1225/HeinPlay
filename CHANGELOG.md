...
<details open>
<summary><h2 style="display: inline;">1.3.3</h2></summary>
...
- **版本号统一**
  - 全项目版本号更新至 `1.3.3`（build `+21`）。
  - Release 产物命名同步为 `heinplay-1.3.3-tv.apk`、`heinplay-1.3.3-tvLegacy.apk`、`heinplay-1.3.3-mobile.apk`、`heinplay-1.3.3-windows-portable.zip`。
  - Windows EXE 资源版本号同步更新为 `1.3.3`，`AppInfoService` 兜底版本号同步更新。
